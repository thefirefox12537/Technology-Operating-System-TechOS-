...
os_boot_start:
	...
	BOOTMSG 'Membangkitkan benih acak'
	call os_seed_random
	BOOTOK
	...
	BOOTMSG 'Mendapatkan parameter boot disk'
	push es
	mov ah, 8
	int 13h
	pop es
	...
	push es
	BOOTMSG 'Memuat kernel ruang pengguna'
	mov ax, 0x2000
	mov es, ax
	...
	call os_load_file
	pop es
	BOOTFATAL_IFCARRY 'Tidak dapat memuat kernel ruang pengguna'
	BOOTOK
	...
	.boot_msg				db "Relativitas Bootloader", DOS_NEWLINE, 0
