...
textmode_finish:
	...
	err_char_in_num		db "Kesalahan: tidak melebihi char pada nomor", 0
	err_cmd_unknown		db "Kesalahan: perintah tidak diketahui", 0
	err_divide_by_zero	db "Kesalahan: berusaha membagi ke nol", 0
	err_doloop_maximum	db "Kesalahan: DO/LOOP sarang melebihi batas", 0
	err_file_notfound	db "Kesalahan: berkas tidak ditemukan", 0
