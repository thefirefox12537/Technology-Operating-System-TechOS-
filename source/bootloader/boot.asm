; ==================================================================
; The Technology Operating System bootloader
; Copyright (C) 2016 The Firefox Foundation -- see doc/LICENSE.TXT
;
; Based on the Mike Operating System and Tachyon Operating System bootloader.
; Copyright (C) 2006 - 2012 MikeOS Developers -- see doc/MikeOS/LICENSE.TXT
; Copyright (C) 2013 - 2018 MikeOS Developers -- see doc/TachyonOS/LICENSE.TXT
;
...
VolumeLabel			db "TECHOS     "	; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "TECHOSK SYS"	; TechOS kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "TECHOSK.SYS not found!", 0
