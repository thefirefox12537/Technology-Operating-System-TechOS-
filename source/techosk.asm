...
%INCLUDE 'features/kernel/boot.asm'
%INCLUDE 'features/kernel/graphics.asm' 
%INCLUDE 'features/kernel/memory.asm'
%INCLUDE 'features/kernel/sound.asm'
%INCLUDE 'features/kernel/screen.asm'
%INCLUDE 'features/kernel/mouse.asm'
%INCLUDE 'features/kernel/keyboard.asm'
%INCLUDE 'features/kernel/math.asm'
%INCLUDE 'features/kernel/ports.asm'
%INCLUDE 'features/kernel/disk.asm'
%INCLUDE 'features/kernel/misc.asm'
