REM >>>HACKLIB<<<
REM Versi Pustaka 1.0.0
REM Copyright (C) The Firefox Foundation.
...
PRINT "HACKLIB (Pustaka Hack) versi 1.0.0"
END
...
SAVEVAR:
  POKEINT Y 65426
  PEEK Y 65421
  IF Y > 198 THEN PRINT "HACKLIB: Tidak ada lagi penyimpanan variabel."
  IF Y > 198 THEN END
  Y = Y + 65200
  POKEINT J Y
  Y = Y + 2
...
LOADVAR:
  POKEINT J 65426
  PEEK J 65421
  IF J = 0 THEN PRINT "HACKLIB: Variabel tidak ditampung."
  IF J = 0 THEN END
  J = J + 65198
  PEEKINT Y J
  J = J - 2
