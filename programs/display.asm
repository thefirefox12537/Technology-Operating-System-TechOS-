...
error:
	...
	.msg_invalid_file			db "Berkas tidak ditemukan.", 0
	.msg_incorrect_identifier		db "Jenis berkas tidak sesuai.", 0
	.msg_bad_version			db "Tidak dapat memuat versi ini.", 0
	.msg_subtype_palette			db "Tidak dapat menampilkan berkas palet.", 0
	.msg_subtype_unknown			db "Berkas subjenis tidak diketahui.", 0
