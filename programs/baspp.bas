REM >>>TechBASIC-PLUS-PLUS-LIBRARY<<<
REM Versi Pustaka 4.1.0
REM Copyright (C) 2016 The Firefox Foundation.
REM Email: reinmclaren33@gmail.com
...
ARRAYGET:
  POKEINT J 65418
  IF X > 99 THEN $8 = "ARRAYGET: Array diluar maksimal"
  IF X > 99 THEN GOTO ERRBOX
  IF X < 0 THEN $8 = "ARRAYGET: Nomor dibawah nol"
...
DINBOX:
  $8 = "INPBOX: Jenis input tidak sah."
...
ERRBOX:
  ...
  pokeint v 65418
  len $8 v
  if v > 38 then $8 = "Kesalahan teks terlalu panjang!"
  if v > 38 then goto fatalerr
  peekint v 65418
  move 22 12
  print $8
  move 22 14
  print "Tekan esc untuk mengakhiri program."
  move 22 15
  print "Tekan sembarang untuk melanjutkan."
  cursor on
  move 53 15
  waitkey j
...
LOADVAR:
  POKEINT J 65426
  PEEK J 65421
  IF J = 0 THEN $8 = "Tidak dapat memuat variabel, pengisian kosong!"
...
MENUBOX:
  ...
  MOVE 22 16
  INK C
  PRINT "Tekan enter untuk memilih opsi."
...
SAVEVAR:
  POKEINT Y 65426
  PEEK Y 65421
  IF Y > 198 THEN $8 = "Area penyimpanan variabel penuh!"
...
sserial:
  if v > 255 then $8 = "Serial: Ukuran Packet terlalu besar!"
