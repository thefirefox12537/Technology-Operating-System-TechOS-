...
.end:
	...
	mus_kbd_title_msg	db 'TechOS Music Keyboard (PC speaker sound)', 0
	mus_kbd_footer_msg	db 'Tekan tombol untuk memulai not, space untuk diamkan not, dan Esc untuk keluar', 0
