...
%define lbbot lbrow+18  ;height
        ...
        bits 16
        %include "techdev.inc" ;TechOS Include file
        org 32768              ;TechOS program area
...
scmsg   db 'Total Skor:  ',0
hkmsg   db 'Kail Tersisa:',0
...
intro:  db 16,'Deep Sea Fisher',0
        db 1,0
        db 47,'Tangkap ikan dan gulung untuk mendapatkan poin',0
        db 46,'di kedalaman, poin sangat bernilai. Jika ikan',0
        db 40,'mengenai tali, kail anda akan terlepas.',0
        db 42,'Saat kail anda habis, permainan berakhir!',0
        db 1,0
        db 43,'Atas menaikkan kail, bawah menurunkan kail',0
        db 46,'Tekan Esc dilain waktu, keluar dari permainan',0
        db 1,0
        db 26,'Tekan Enter untuk memulai',0
es      db 0
