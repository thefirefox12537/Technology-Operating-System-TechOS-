...
close:
	...
	err_string	db 'Silahkan pilih berkas TXT, BAS atau PCX!', 0

	title_msg	db 'Penampil Berkas TechOS', 0
	footer_msg	db 'Pilih berkas TXT, BAS atau PCX untuk tampil, atau tekan Esc untuk keluar', 0

	txt_title_msg	db 'Penampil Berkas Teks TechOS', 0
	txt_footer_msg	db 'Gunakan tombol panah untuk menggulung dan Q untuk keluar', 0
